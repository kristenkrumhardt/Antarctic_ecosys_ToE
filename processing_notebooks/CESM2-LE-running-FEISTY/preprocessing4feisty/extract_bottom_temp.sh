...
outpath=/glade/derecho/scratch/kristenk/CESM2-LE-processing/TEMP_bottom/
...
do 
  ...
  if ! [ -f $outfile ]; then
      ...
      ## Add "_bottom" suffix to variable name in output file
      ncrename -v TEMP,TEMP_bottom $outfile
